...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.alarm1) {
            ...
            Snackbar.make(v,"Snackbar!!!", Snackbar.LENGTH_INDEFINITE).show();
        } else if (v.getId() == R.id.alarm3) {
            Snackbar.make(v,"Snackbar!!!", Snackbar.LENGTH_INDEFINITE).setAction("닫기", new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            new AlertDialog.Builder(this).setIcon(R.mipmap.ic_launcher).setTitle("Dialog")
